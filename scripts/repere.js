...
var bottomCorner = document.getElementById("bottomCorner");
...
function moveRepere() {
    ...
    if (
        ...
        navigation.style.setProperty('width', currentX.toString() - 3 + "px");
        bottomCorner.style.setProperty('width', currentX.toString() + "px");
